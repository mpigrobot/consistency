...
%  Modified from Hugh's 'inn_analyse' function by Samuel(sunzuolei@gmail.com). 
%  Please refer to p74-76 of  'Introduction to Estimation and the Kalman
%  Filter' for details.
% 
%   Input arguments:
%       Y       - Innovation, should be column matrix;
%       S       - The covariance matrix of Y;
%       type    - 'movingAverage' or 'batch';
%   Output arguments:
...
%       chiLow  - The low bound of the specified chi-square
